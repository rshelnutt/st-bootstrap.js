!function(e, t) {
    ...
    function c(e, t, n, r) {
        if (ie.acceptData(e)) {
            ...
            if (u && l[u] && (r || l[u].data) || void 0 !== n || "string" != typeof t)
                return u || (u = s ? e[a] = Y.pop() || ie.guid++ : a),
                l[u] || (l[u] = s ? {} : {
                    toJSON: ie.noop
                }),
    ...
    function A(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++)
            ...
            r.style && (o[a] = ie._data(r, "olddisplay"),
                ...
                "" === r.style.display && Ae(r) && (o[a] = ie._data(r, "olddisplay", N(r.nodeName)))) : (i = Ae(r),
    ...
    function O(e, t, n) {
        ...
        1 === e.nodeType && ("height"in t || "width"in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY],
            u = ie.css(e, "display"),
            c = "none" === u ? ie._data(e, "olddisplay") || N(e.nodeName) : u,
        "inline" === c && "none" === ie.css(e, "float") && (ne.inlineBlockNeedsLayout && "inline" !== N(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")),
        ...
        if (ie.isEmptyObject(f))
            "inline" === ("none" === u ? N(e.nodeName) : u) && (p.display = u);
        else {
        ...
        ie.extend({
            ...
            proxy: function(e, t) {
                ...
                return "string" == typeof t && (i = e[t],
                    t = e,
                    e = i),
                    ie.isFunction(e) ? (n = J.call(arguments, 2),
                        r = function() {
    ...
    var ue = function(e) {
        function t(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : B) !== H && L(t),
                    t = t || H,
                    n = n || [],
                    s = t.nodeType,
        ...
        var x, w, T, C, E, N, k, S, A, D, j, L, H, _, q, M, O, F, P, W = "sizzle" + 1 * new Date, B = e.document, R = 0, z = 0, $ = n(), I = n(), X = n(), V = function(e, t) {
            return e === t && (j = !0),
                0
        }, U = 1 << 31, Y = {}.hasOwnProperty, J = [], G = J.pop, Q = J.push, K = J.push, Z = J.slice, ee = function(e, t) {
        ...
        w = t.support = {},
            ...
            L = t.setDocument = function(e) {
                ...
                (w.matchesSelector = ve.test(F = _.matches || _.webkitMatchesSelector || _.mozMatchesSelector || _.oMatchesSelector || _.msMatchesSelector)) && i(function(e) {
                    ...
                    P = t || ve.test(_.contains) ? function(e, t) {
                    ...
                    V = t ? function(e, t) {
                            ...
                            return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1,
                                1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === r || e.ownerDocument === B && P(B, e) ? -1 : t === r || t.ownerDocument === B && P(B, t) ? 1 : D ? ee(D, e) - ee(D, t) : 0 : 4 & n ? -1 : 1)
                        }
                        : function(e, t) {
                            if (e === t)
                                return j = !0,
        ...
        return d.prototype = T.filters = T.pseudos,
            ...
            ,
            w.sortStable = W.split("").sort(V).join("") === W,
    ...
    Je.optgroup = Je.option,
        ...
        ie.extend({
            clone: function(e, t, n) {
                ...
                if (ne.html5Clone || ie.isXMLDoc(e) || !Pe.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Qe.innerHTML = e.outerHTML,
                    ...
                    if (o = e[h],
                        ...
                        if ("object" === ie.type(o))
                            ...
                            if (!ne.leadingWhitespace && We.test(o) && p.push(t.createTextNode(We.exec(o)[0])),
                                    !ne.tbody)
                                for (o = "table" !== l || ze.test(o) ? "<table>" !== c[1] || ze.test(o) ? 0 : s : s.firstChild,
        ...
        ie.fn.extend({
            ...
            html: function(e) {
                return De(this, function(e) {
                    ...
                    if ("string" == typeof e && !Ie.test(e) && (ne.htmlSerialize || !Pe.test(e)) && (ne.leadingWhitespace || !We.test(e)) && !Je[(Re.exec(e) || ["", ""])[1].toLowerCase()]) {
                        e = e.replace(Be, "<$1></$2>");
                        try {
                            for (; r > n; n++)
                                t = this[n] || {},
                ...
                if (u && (s = ie.buildFragment(e, this[0].ownerDocument, !1, this),
                    ...
                    if (i)
                        for (a = o[o.length - 1].ownerDocument,
                                 ...
                                 l = 0; i > l; l++)
                            r = o[l],
                            Ve.test(r.type || "") && !ie._data(r, "globalEval") && ie.contains(a, r) && (r.src ? ie._evalUrl && ie._evalUrl(r.src) : ie.globalEval((r.text || r.textContent || r.innerHTML || "").replace(Ye, "")));
                    s = n = null
                }
                return this
            }
    ...
    ne.opacity || (ie.cssHooks.opacity = {
        ...
        ie.fx.step = {};
    var pt, ht, mt = /^(?:toggle|show|hide)$/, gt = new RegExp("^(?:([+-])=|)(" + ke + ")([a-z%]*)$","i"), vt = /queueHooks$/, yt = [O], bt = {
        "*": [function(e, t) {
    ...
    ie.fn.extend({
        ...
        ie.extend({
            ...
            removeAttr: function(e, t) {
                ...
                if (o && 1 === e.nodeType)
                    for (; n = o[i++]; )
                        r = ie.propFix[n] || n,
                            ie.expr.match.bool.test(n) ? kt && Nt || !Et.test(n) ? e[r] = !1 : e[ie.camelCase("default-" + n)] = e[r] = !1 : ie.attr(e, n, ""),
        ...
        Tt = {
            set: function(e, t, n) {
                return t === !1 ? ie.removeAttr(e, n) : kt && Nt || !Et.test(n) ? e.setAttribute(!Nt && ie.propFix[n] || n, n) : e[ie.camelCase("default-" + n)] = e[n] = !0,
                    n
            }
        },
        ie.each(ie.expr.match.bool.source.match(/\w+/g), function(e, t) {
            var n = Ct[t] || ie.find.attr;
            Ct[t] = kt && Nt || !Et.test(t) ? function(e, t, r) {
                    var i, o;
                    return r || (o = Ct[t],
                        Ct[t] = i,
    ...
    ;
    var _t, qt, Mt = /#.*$/, Ot = /([?&])_=[^&]*/, Ft = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Pt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Wt = /^(?:GET|HEAD)$/, Bt = /^\/\//, Rt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, zt = {}, $t = {}, It = "*/".concat("*");
    try {
        qt = location.href
    } catch (Xt) {
        ...
        ie.extend({
            ...
            ajax: function(e, t) {
                ...
                if (h.promise(w).complete = m.add,
                        w.success = w.done,
                        w.error = w.fail,
                        d.url = ((e || d.url || qt) + "").replace(Mt, "").replace(Bt, _t[1] + "//"),
                ...
                d.hasContent || (d.data && (o = d.url += (Lt.test(o) ? "&" : "?") + d.data,
                    delete d.data),
                d.cache === !1 && (d.url = Ot.test(o) ? o.replace(Ot, "$1_=" + jt++) : o + (Lt.test(o) ? "&" : "?") + "_=" + jt++)),
                            ...
                            i = t[n],
                                ...
                                r.push(function() {
                                    ...
                                    for (a = this.vendors,
                                             ...
                                             r = a.length; r > t; t++)
                                        o = a[t],
                                            s.push(e["" + o + n.charAt(0).toUpperCase() + n.substr(1)] = i);
                                    return s
                                }
                                    .call(this));
                        return r
    ...
    function(e, t) {
        t(function() {
            (new WOW).init(),
            "https://api.instagram.com/oauth/authorize/?" + t.param({
                client_id: null,
